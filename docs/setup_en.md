...
Want a YAML that looks like what you'd get when exporting it from the site? Grab the [PM Sample.yaml file.](https://github.com/JKBSunshine/PMR_APWorld/blob/main/docs/PM%20Sample.yaml)  
...
Want a GUI with buttons, sliders, descriptions, and cute styling? Grab the [PMR Settings String.yaml file.](https://github.com/JKBSunshine/PMR_APWorld/blob/main/docs/PMR%20Settings%20String.yaml)
